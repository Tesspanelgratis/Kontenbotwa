...
/////////////////
const BotName = 'BOT WA NO SCAN☄'; 
const instagram = 'https://www.instagram.com/gusbotzx_offc?igsh=MWd6ejJ4dTljbnNlZQ=='; 
const telegram = 'https://t.me/omGusbotzx_my'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/@Gussbotzx.my.id55';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:gusbitzx_offc')
